...
type Build struct {
	...
	Context    string `protobuf:"bytes,2,opt,name=Context,proto3" json:"Context,omitempty" hcl:"context"`
}
...
type Component struct {
	...
	// to the internet
	External bool `protobuf:"varint,8,opt,name=External,proto3" json:"External,omitempty" hcl:"external" hcle:"omitempty" yaml:",omitempty"`
	// True if this is the head of the stack i.e. consumable api.
	Head bool `protobuf:"varint,9,opt,name=Head,proto3" json:"Head,omitempty" hcl:"head" hcle:"omitempty" yaml:",omitempty"`
	// Envionment variables
	Env *Envionment `protobuf:"bytes,10,opt,name=Env" json:"Env,omitempty" hcl:"env" hcle:"omitempty" yaml:",omitempty"`
	// Arbitrary KV config map
	Config map[string]string `protobuf:"bytes,11,rep,name=Config" json:"Config,omitempty" hcl:"config" hcle:"omitempty" yaml:",omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type Language struct {
	...
	IgnoreExts []string `protobuf:"bytes,5,rep,name=IgnoreExts" json:"IgnoreExts,omitempty"`
...
func (*Language) Descriptor() ([]byte, []int) { return fileDescriptorThrap, []int{4} }
...
func (m *Language) GetIgnoreExts() []string {
	if m != nil {
		return m.IgnoreExts
	}
	return nil
...
type Stack struct {
	...
	Version      string                `protobuf:"bytes,4,opt,name=Version,proto3" json:"Version,omitempty" hcl:"version" hcle:"omit" yaml:",omitempty"`
...
func (*Stack) Descriptor() ([]byte, []int) { return fileDescriptorThrap, []int{5} }
...
func (*ChainHeader) Descriptor() ([]byte, []int) { return fileDescriptorThrap, []int{6} }
...
func (*Identity) Descriptor() ([]byte, []int) { return fileDescriptorThrap, []int{7} }
...
func (m *Language) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IgnoreExts) > 0 {
		for _, s := range m.IgnoreExts {
			dAtA[i] = 0x2a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *Language) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IgnoreExts", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IgnoreExts = append(m.IgnoreExts, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
...
var fileDescriptorThrap = []byte{
	...
	,
}
