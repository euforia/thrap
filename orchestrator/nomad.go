...
// func (orch *nomadOrchestrator) NewSpec(name string) ([]string, error) {
// 	jobstr := fmt.Sprintf(nomadJobTemplate, name)
// 	return []string{jobstr}, nil
// }
//
// var nomadJobTemplate = strings.TrimSpace(`
